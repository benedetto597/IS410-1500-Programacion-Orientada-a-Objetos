...
<head>
    ...
    <title>Mini-Mall | Categorías</title>
...
<body>
    <main>
        ...
        <div class="container p-0 animated bounceInUp">
            <div class="row row-col-4">
                <!-- Card Categoría -->
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fas fa-utensils fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Comida</b>
                            <h6 class="card-text">Servicio a domocilio</h6>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-dark">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-mug-hot fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Bebida</b>
                            <h6 class="card-text">Servicio a domocilio</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-secundary">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-tshirt fa-5x" style="color: white;"></i></button>
                        </div>
                        <div class="card-body p-3 text-white">
                            <b>Ropa</b>
                            <h6 class="card-text text-white">Compra inmediata</h6>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-dark">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-cocktail fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Alcohol</b>
                            <h6 class="card-text">Servicio a domocilio</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-dark">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-plug fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Electronica</b>
                            <h6 class="card-text">Compra inmediata</h6>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-secundary">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-laptop-code fa-5x" style="color: white;"></i></button>
                        </div>
                        <div class="card-body p-3 text-white">
                            <b>Software</b>
                            <h6 class="card-text text-white">Compra inmediata</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0 bg-dark">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-first-aid fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Salud</b>
                            <h6 class="card-text">Servicio a domocilio</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-xs-12 my-1 p-0 m-0">
                    <div class="card w-75 h-75 border-0">
                        <div class="card-header border-0 mr-auto ml-auto bg-transparent">
                            <button class="border-0 bg-transparent"><i
                                    class="fas fa-home fa-5x"></i></button>
                        </div>
                        <div class="card-body p-3">
                            <b>Hogar</b>
                            <h6 class="card-text">Compra inmediata</h6>
    ...
    <script src="js/control-categories-promotions.js"></script>
</body>
