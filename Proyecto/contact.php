...
<head>
    ...
    <title>Mini Mall | Contacto</title>
    ...
    <main>
        ...
        <div class="container-fluid">
            <form class="row" action="">
                <div class="col-lg-6 col-xl-6 col-md-2 col-xs-1 col-sm-1"></div>
                <div class="col-lg-5 col-xl-5 col-md-8 col-xs-10 col-sm-10 px-5 animated bounceInLeft" id="form-admin">
                    <div class="form-row align-items-center">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="name-contact" placeholder="Nombre Completo">
                        </div>

                        <div class="form-group col-md-12">
                            <b class="text-white">Correo</b>
                            <input type="email" class="form-control" id="email-contact" placeholder="Correo">
                        </div>

                        <div class="form-group col-md-12">
                            <b class="text-white">Telefono</b>
                            <input type="tel" class="form-control" id="phone-contact" placeholder="Número Telefonico">
                        </div>

                        <div class="form-group col-md-12">
                            <b class="text-white">Mensaje</b>
                            <textarea name="" id="message-contact" class="form-control"
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-auto mr-auto ml-auto">
                            <button type="button" id="btn-admin-register"
                                class="btn btn-lg shadow p-2 px-5 my-4 mb-0 bg-white rounded-pill">Enviar</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-1 col-xl-1 col-md-2 col-xs-1 col-sm-1"></div>
            </form>
        </div>
    </main>
