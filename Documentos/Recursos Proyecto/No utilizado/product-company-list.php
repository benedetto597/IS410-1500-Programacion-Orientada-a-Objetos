...
<body>
    <main>
        ...
        <div class="animated bounceInUp">
            <div class="col-md-6 ml-auto mr-auto my-3">
                <input type="text" name="busqueda" id="busqueda" placeholder="Buscar Producto o Empresa"
                    class="form-control bg-transparent my-3 bm-2 border border-warning">
            </div>
            <div class="table-wrapper-scroll-y my-custom-scrollbar" style="height: 25rem;">
    ...
    <script src="js/controlado-list-promotions.js"></script>
</body>
